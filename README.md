...
The goal of this explanation is to help people visualize the logic of GJK in imagination. To explain how it works we have to oversimplify certain things. All math except basic arithmetic and a little of vector math is used, nothing more, so that even a 3rd-grader would understand it.
