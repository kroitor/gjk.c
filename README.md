...
The two tested polygons are defined as arrays of plain C vector struct { float x; float y; }. This implementation of GJK doesn't really care about the order of the vertices in the arrays, as it treats all polygons as convex shapes. But it is better to have them ordered  *counter-clockwise for compatibility*.
