...
Let's start with a naive example of computing difference of shapes in one dimension. A segment of a number line is an example of 1D-shape. Imagine we have two segments on the number line: segment `[1,3]` and segment `[2,4]`:
