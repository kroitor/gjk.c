...
Now we set our final direction `D` to that perpendicular to `CB` pointing towards Origin. That will be a direction to search for point A of our triangle simplex. This is also the last stage of the evolution of the 2-simplex. We call our support function and pass new direction `D` along with the two shapes. The image below shows the result after calling the support function the 3rd time:

![The GJK simplex after completing the 3rd stage of evolution](https://cloud.githubusercontent.com/assets/1294454/25314806/523d6236-2853-11e7-8c50-5e35404ff9a6.jpg)
