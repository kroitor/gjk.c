...
7. Once two opposite points A and B have been found, subtract one from the other and done. It doesn't matter which one you are subtracting from. The resulting vector is a mapping of their difference into 2D Minkowski space.
